...
core::ProviderID GeminiProvider::ProviderId() const {
    return "gemini";
}

bool GeminiProvider::SupportsModel(const core::ModelID& model) const {
...
std::shared_ptr<core::ChatResponse> GeminiProvider::Chat(const core::ChatRequest& req) {
