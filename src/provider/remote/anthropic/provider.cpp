...
core::ProviderID AnthropicProvider::ProviderId() const {
    return "anthropic";
}

bool AnthropicProvider::SupportsModel(const core::ModelID& model) const {
...
std::shared_ptr<core::ChatResponse> AnthropicProvider::Chat(const core::ChatRequest& req) {
