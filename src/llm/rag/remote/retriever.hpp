...
/// @file
/// Remote RAG retriever implementation.
...
/// Retriever implementation that queries a backend via HTTP.
///
...
public:
    ...
    RemoteRetriever(const llm::ProviderConfig& cfg, std::shared_ptr<hal::HttpClient> http_client);
