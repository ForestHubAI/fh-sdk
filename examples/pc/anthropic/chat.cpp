// =============================================================================
// Anthropic PC Chat Example
// =============================================================================
// Simple chat request on PC. Sends a single prompt to the LLM and prints the
// response. Requires ANTHROPIC_API_KEY environment variable.
// =============================================================================
...
int main() {  // NOLINT(bugprone-exception-escape)
    ...
    // Print banner
    platform->console->Printf("=== Anthropic Chat (PC Platform) ===\n\n");
    ...
    if (!api_key_env) {
        ...
        platform->console->Printf("        Please export it before running: export ANTHROPIC_API_KEY=...\n");
        platform->console->Flush();
        return 1;
    }
    ...
    // Configure the Remote Provider (Anthropic)
