...
TEST(OpenAIProvider, ChatTextResponse) {
    ...
    llm::ChatRequest req("gpt-4o", input);
...
TEST(OpenAIProvider, ChatWithPreviousResponseId) {
    ...
    auto input = std::make_shared<llm::InputString>("Continue");
    llm::ChatRequest req("gpt-4o", input);
...
TEST(OpenAIProvider, ChatWithTools) {
    ...
    auto input = std::make_shared<llm::InputString>("Search for weather");
    llm::ChatRequest req("gpt-4o", input);
...
TEST(OpenAIProvider, ChatToolResultInput) {
    ...
    llm::ChatRequest req("gpt-4o", items);
    provider.Chat(req);
...
TEST(OpenAIProvider, ChatWebSearchResponse) {
    ...
    auto ws = std::static_pointer_cast<llm::WebSearchToolCall>(resp->tools_called[0]);
...
TEST(OpenAIProvider, ChatWithNullInput) {
    ...
    llm::ChatRequest req("gpt-4o", nullptr);
    provider.Chat(req);
