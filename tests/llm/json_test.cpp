...
TEST(JsonTest, SerializeToolCallRequestViaPointer) {
    ...
    json j;
    foresthub::llm::to_json(j, item);  // Also possible json j = item;
...
TEST(JsonTest, SerializeNullInputItemPointer) {
    ...
    json j;
    foresthub::llm::to_json(j, null_item);
...
TEST(JsonTest, SerializeNullToolPointer) {
    ...
    json j;
    foresthub::llm::to_json(j, null_tool);
...
TEST(JsonTest, SerializeOptionsAllFields) {
    ...
    Options opts2;
    foresthub::llm::from_json(j, opts2);
